<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="industrial-automation.aspx.cs" Inherits="industrial_automation" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        <div class="pbmit-title-bar-wrapper" style="background: url(new-img/indus/6.png);background-size:cover">
        <div class="container">
            <div class="pbmit-title-bar-content">
                <div class="pbmit-title-bar-content-inner">
                    <div class="pbmit-tbar">
                        <div class="pbmit-tbar-inner container">
                            <h1 class="pbmit-tbar-title">Our Industrial Automation Capabilities</h1>
                        </div>
                    </div>
                    <div class="pbmit-breadcrumb">
                        <div class="pbmit-breadcrumb-inner">
                            ...
                            <span><span class="post-root post post-post current-item">Industrial Automation</span></span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row row-gap-gutter">
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="industry-card">
                            ...
                            <div class="content">
                                <h3>CNC Machining</h3>
                                <p>Precision machining for components and assemblies used in industrial automation systems,
ensuring exact tolerances and high performance.  </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="industry-card">
                            ...
                            <div class="content">
                                <h3>Sheet Metal</h3>
                                <p>Custom sheet metal fabrication for enclosures, panels, and structural elements, designed for
durability and functionality in automation environments. </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="industry-card">
                            ...
                            <div class="content">
                                <h3>Fabrication</h3>
                                <p>Robust fabrication solutions for complex automation assemblies, providing the strength and
reliability needed for demanding industrial applications.  </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="industry-card">
                            ...
                            <div class="content">
                                <h3>Casting</h3>
                                <p>High-quality casting services for critical automation parts, delivering the strength and durability
required for industrial operations.  </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="industry-card">
                            ...
                            <div class="content">
                                <h3>Forging</h3>
                                <p> Durable forged components that meet the rigorous performance standards of industrial
automation systems, ensuring long-lasting reliability.  </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="industry-card">
                            ...
                            <div class="content">
                                ...
                                <p>Precision plastic parts and housings molded to exact specifications, suitable for a variety of
automation applications.  </p>
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="industry-card">
                            ...
                            <div class="content">
                                <h3>3D Printing</h3>
                                <p>Rapid prototyping and production of intricate automation components, enabling quick iterations
and customized solutions. </p>
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="industry-card">
                            ...
                            <div class="content">
                                <h3>Wire Harness</h3>
                                <p>Efficient and reliable wire harnesses for automation control systems, ensuring seamless
connectivity and optimal performance.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="industry-card">
                            ...
                            <div class="content">
                                <h3>PCB Assembly</h3>
                                <p>Advanced assembly for printed circuit boards used in automation electronics, providing
dependable performance in critical systems. </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="industry-card">
                            ...
                            <div class="content">
                                <h3>Box Build</h3>
                                <p>Custom enclosures and assemblies, integrating multiple components into complete automation
...
functionality of automation systems.  </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="industry-card">
                            ...
                            <div class="content">
                                <h3>Built-to-Spec</h3>
                                <p>Tailored manufacturing solutions that meet precise specifications, delivering components and
systems exactly as required for industrial automation. </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="industry-card">
                            ...
                            <div class="content">
                                ...
                                <p>
                                    Accurate replication and enhancement of existing automation components, providing valuable
                ...
                <div class="row">
                    <div class="col-md-6 box-left-col">
                        <div class="box-wrap ps-0">
                            ...
                            <p>
                                <strong>Ensuring Excellence in Industrial Automation Manufacturing</strong>
                                <br />
                               ZPROTO is committed to maintaining the highest quality standards through our certification and
partner onboarding processes. Our certifications include: 
                            </p>
                ...
                <div class="row flex-row-reverse mt-60">
                    <div class="col-md-6 box-left-col">
                        <div class="box-wrap">
                            ...
                            <ul class="list-group list-group-borderless">
                                <li class="list-group-item">
                                    <span class="pbmit-icon-list-text"><strong>Quality Audits:</strong> Thorough evaluations of manufacturing processes and quality
control systems specific to industrial automation.</span>
                                </li>
                                <li class="list-group-item">
...
production requirements for automation components.</span>
                                </li>
                                <li class="list-group-item">
...
certifications for industrial automation manufacturing.</span>
                                </li>
                            </ul>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="pbmit-heading-subheading animation-style2 text-center">
                            <h2 class="pbmit-title mb-3" style="perspective: 400px;">Why Choose ZPROTO for Industrial Automation?</h2>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="pbmit-ihbox-style-1 process-card">
                                <div class="pbmit-ihbox-headingicon">
                                    <div class="pbmit-ihbox-contents">
                                        ...
                                        <div class="pbmit-heading-desc">High-quality solutions for sophisticated automation
systems.</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="pbmit-ihbox-style-1 process-card">
                                <div class="pbmit-ihbox-headingicon">
                                    <div class="pbmit-ihbox-contents">
                                        ...
                                        <div class="pbmit-heading-desc">Cutting-edge tools and techniques for superior automation
components.</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="pbmit-ihbox-style-1 process-card">
                                <div class="pbmit-ihbox-headingicon">
                                    <div class="pbmit-ihbox-contents">
                                        ...
                                        <div class="pbmit-heading-desc"> Professionals with extensive experience in industrial automation
manufacturing.</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="pbmit-ihbox-style-1 process-card">
                                <div class="pbmit-ihbox-headingicon">
                                    <div class="pbmit-ihbox-contents">
                                        ...
                                        <div class="pbmit-heading-desc">Tailored services to meet the unique needs of your automation
designs.</div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="pbmit-ele-header-align-center">
                        <div class="pbmit-heading-subheading text-center animation-style2">
                            ...
                            <p class="text-center text-white mt-2">
                             Explore Our Industrial Automation Projects to see how we’ve supported advanced
automation systems with our manufacturing expertise. 
                            </p>
                        </div>
                        ...
                        <div class="col-md-8 tween-effect-center-col">
                            <div class="tween-effect-wrap">
                                <div class="pbmit-heading-subheading  text-start animation-style2">
                                    <h2 class="pbmit-title">Start Your Industrial Automation Project</h2>
                                    <div class="pbmit-heading-desc">
                                       Elevate your industrial automation systems with ZPROTO’s precision manufacturing solutions.Contact Us today to discuss your needs or schedule a consultation or Sign Up to send an
enquiry. 
                                    </div>
                                </div>
