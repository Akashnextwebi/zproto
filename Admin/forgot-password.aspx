...
<head runat="server">
    <title>ZPROTO Password Recovery</title>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <div class="text-center mt-2">
                                                ...
                                                <p class="text-muted">Reset password with ZPROTO Admin</p>
                                            </div>
                                            ...
                                            <div class="p-2 mb-4">
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    <asp:TextBox ID="txtEmail" runat="server"  CssClass="form-control" placeholder="Enter Email" MaxLength="100" />
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="text-center">
                                <p class="mb-0 text-muted"><a href="https://www.nextwebi.com/" class="mb-0 text-muted" target="_blank">Designed & Developed by Nextwebi</a>
                            </div>
                        </div>
                    </div>
                </div>
