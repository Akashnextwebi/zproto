$(document).ready(function () {
    $(document.body).on('click', '.btnmsg', function () {
        ...
        $('.modal-header .modal-title').html('About Project');
        $.ajax({
            type: 'POST',
            url: "manufacturing-partner.aspx/GetMessage",
            data: "{id: '" + id + "'}",
            ...
            success: function (res) {
                ...
                if (Message) {
                    ...
                    $("#Contactinfosingle").html("No Details Found.");
                }
            }
        });
    });
    ...
    $(document.body).on('click', '.deleteItem', function () {
        ...
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    type: 'POST',
                    url: "manufacturing-partner.aspx/Delete",
                    data: "{id: '" + id + "'}",
                    contentType: 'application/json; charset=utf-8',
                    dataType: "json",
                    async: false,
