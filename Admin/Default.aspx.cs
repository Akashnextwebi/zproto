    ...
    protected void btnLogin_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            if (Page.IsValid)
            {
                ...
                CreateUser logins = CreateUser.Login(conZP, inputs);
                if (logins.UserGuid != null)
                {
                    ...
                    else if (logins.Status == "Active")
                    {
                        ...
                        HttpCookie cookie = new HttpCookie("zp_aid");
                        cookie.Value = logins.UserGuid;

                        //this cookie is to validate password key
                        HttpCookie cookie_pass_key = new HttpCookie("zp_apkv");
                        ...
                        CreateUser.UpdateLastLoginTime(conZP, logins.UserGuid);
