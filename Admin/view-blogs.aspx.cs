...
public partial class Admin_view_blogs : System.Web.UI.Page
{
    ...
    public void GetAllBlogDetails()
    {
        ...
        {
            strBlogs = "";
            List<BlogDetails> blog = BlogDetails.GetAllBlogDetails(conZP).ToList();
            int i = 0;
            foreach (BlogDetails pro in blog)
            {
                ...
                strBlogs += @"<tr>
                                ...
                                <td class='text-center'> 
                                                <a href='add-blog.aspx?id=" + pro.Id + @"' class='bs-tooltip fs-18' data-id='" + pro.Id + @"' data-bs-toggle='tooltip' data-placement='top' title='Edit'>
    ...
    public static string Delete(string id)
    {
        ...
        try
        {
            ...
            int exec = BlogDetails.DeleteBlogDetails(conZP, BD);
            if (exec > 0)
            {
                x = "Success";
            }
