<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="medical-devices.aspx.cs" Inherits="medical_devices" %>
                ...
                <div class="pbmit-title-bar-content-inner">
                    <div class="pbmit-tbar">
                        <div class="pbmit-tbar-inner container">
                            <h1 class="pbmit-tbar-title">Our Medical Devices Capabilities</h1>
                        </div>
                    </div>
                    <div class="pbmit-breadcrumb">
                        <div class="pbmit-breadcrumb-inner">
                            ...
                            <span><span class="post-root post post-post current-item">Medical Devices</span></span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row row-gap-gutter">
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="industry-card">
                            ...
                            <div class="content">
                                <h3>CNC Machining</h3>
                                <p>High-precision machining for medical device components, including intricate parts and
assemblies, crafted to meet exacting standards.  </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="industry-card">
                            ...
                            <div class="content">
                                <h3>Sheet Metal</h3>
                                <p>Custom sheet metal fabrication for medical device enclosures and structural components,
ensuring durability and protection for sensitive equipment.  </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="industry-card">
                            ...
                            <div class="content">
                                <h3>Fabrication</h3>
                                <p>Robust fabrication solutions for complex medical device assemblies, providing strength and
reliability in critical applications.  </p>
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="industry-card">
                            ...
                            <div class="content">
                                <h3>Casting</h3>
                                <p>High-quality casting services for essential medical device parts, offering the strength and
consistency needed for medical applications.  </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="industry-card">
                            ...
                            <div class="content">
                                <h3>Forging</h3>
                                <p>Durable forged components that meet rigorous medical device performance standards, ensuring
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="industry-card">
                            ...
                            <div class="content">
                                ...
                                <p>Precision plastic parts and housings molded to exact specifications, suitable for a wide range of
medical device applications.  </p>
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="industry-card">
                            ...
                            <div class="content">
                                <h3>3D Printing</h3>
                                <p>Rapid prototyping and production of detailed medical device components, enabling quick
iterations and custom solutions for innovative designs. </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="industry-card">
                            ...
                            <div class="content">
                                <h3>Wire Harness</h3>
                                <p>Efficient and reliable wire harnesses for medical device electrical systems, ensuring seamless
connectivity and functionality.   </p>
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="industry-card">
                            ...
                            <div class="content">
                                <h3>PCB Assembly</h3>
                                <p>Advanced PCB assembly for medical device electronics, providing reliable performance in
critical healthcare applications.  </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-4">
...
systems exactly as required for medical devices.  </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="industry-card">
                            ...
                            <div class="content">
                                ...
                                <p>
                                   Accurate replication and enhancement of existing medical device components, providing
                ...
                <div class="row">
                    <div class="col-md-6 box-left-col">
                        <div class="box-wrap ps-0">
                            ...
                            <p>
                                <strong>Commitment to Excellence in Medical Device Manufacturing</strong>
                                <br />
                              ZPROTO ensures the highest quality standards through our rigorous certification and partner
onboarding processes. Our certifications include: 
                            </p>
                            <ul class="list-group list-group-borderless">
                                <li class="list-group-item">
    <span class="pbmit-icon-list-text"><strong>ISO 13485:</strong> Medical Devices Quality Management Systems</span>
</li>
                                <li class="list-group-item">
                ...
                <div class="row flex-row-reverse mt-60">
                    <div class="col-md-6 box-left-col">
                        <div class="box-wrap">
                            ...
                            <ul class="list-group list-group-borderless">
                                <li class="list-group-item">
                                    <span class="pbmit-icon-list-text"><strong>Quality Audits:</strong> In-depth assessments of manufacturing processes and quality
control systems specific to medical devices.</span>
                                </li>
                                <li class="list-group-item">
...
production requirements for medical device components.</span>
                                </li>
                                <li class="list-group-item">
...
certifications for medical device manufacturing.</span>
                                </li>
                            </ul>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="pbmit-heading-subheading animation-style2 text-center">
                            <h2 class="pbmit-title mb-3" style="perspective: 400px;">Why Choose ZPROTO for Medical Devices?</h2>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="pbmit-ihbox-style-1 process-card">
                                <div class="pbmit-ihbox-headingicon">
                                    <div class="pbmit-ihbox-contents">
                                        ...
                                        <div class="pbmit-heading-desc">High-quality solutions for critical medical device
applications.</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="pbmit-ihbox-style-1 process-card">
                                <div class="pbmit-ihbox-headingicon">
                                    <div class="pbmit-ihbox-contents">
                                        ...
                                        <div class="pbmit-heading-desc">Professionals with extensive experience in medical device
manufacturing.</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="pbmit-ihbox-style-1 process-card">
                                <div class="pbmit-ihbox-headingicon">
                                    <div class="pbmit-ihbox-contents">
                                        ...
                                        <div class="pbmit-heading-desc">Tailored services to meet the unique needs of your medical
device designs.</div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="pbmit-ele-header-align-center">
                        <div class="pbmit-heading-subheading text-center animation-style2">
                            ...
                            <p class="text-center text-white mt-2">
                              Explore Our Medical Device Projects to see how we’ve supported innovative medical device
designs with our advanced manufacturing capabilities. 
                            </p>
                        </div>
                        ...
                        <div class="col-md-8 tween-effect-center-col">
                            <div class="tween-effect-wrap">
                                <div class="pbmit-heading-subheading  text-start animation-style2">
                                    <h2 class="pbmit-title">Start Your Medical Device Project</h2>
                                    <div class="pbmit-heading-desc">
                                        Enhance your medical device designs with ZPROTO’s precision manufacturing solutions.
