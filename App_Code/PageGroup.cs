...
public class PageGroup
{
    ...
    public static List<PageGroup> GetAllPageGroup(SqlConnection conZP)
    {
    ...
    public static int InsertPageGroup(SqlConnection conZP, PageGroup cat)
    {
        int result = 0;
    ...
    public static int UpdatePageGroup(SqlConnection conZP, PageGroup cat)
    {
        int result = 0;
    ...
    public static int DeletePageGroup(SqlConnection conZP, PageGroup cat)
    {
        int result = 0;
