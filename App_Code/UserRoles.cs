...
public class UserRoles
{
    ...
    public static List<UserRoles> GetAllUserRoles(SqlConnection conZP)
    {
    ...
    public static int InsertUserRoles(SqlConnection conZP, UserRoles cat)
    {
        int result = 0;
    ...
    public static int UpdateUserRoles(SqlConnection conZP, UserRoles cat)
    {
        int result = 0;
    ...
    public static int DeleteUserRoles(SqlConnection conZP, UserRoles cat)
    {
        int result = 0;
    ...
    public static List<UserRolesAccess> GetAllUserRoles(SqlConnection conZP, string roleId)
    {
    ...
    public static List<UserRolesAccess> GetAllUserRolesCheck(SqlConnection conZP, string roleId, string pid)
    {
        List<UserRolesAccess> categories = new List<UserRolesAccess>();
        try
        {
    ...
    public static int InsertToRoleAccess(SqlConnection conZP, UserRolesAccess cat)
    {
        int result = 0;
    ...
    public static int UpdateRoleAccess(SqlConnection conZP, UserRolesAccess cat)
    {
        int result = 0;
