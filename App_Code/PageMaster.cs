...
public class PageMaster
{
    ...
    public static List<PageMaster> GetAllPageMaster(SqlConnection conZP)
    {
    ...
    public static int InsertPageMaster(SqlConnection conZP, PageMaster cat)
    {
        int result = 0;
    ...
    public static int UpdatePageMaster(SqlConnection conZP, PageMaster cat)
    {
        int result = 0;
    ...
    public static int DeletePageMaster(SqlConnection conZP, PageMaster cat)
    {
        int result = 0;
