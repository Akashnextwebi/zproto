...
public class ExceptionCapture
{
    ...
    public static void CaptureException(string pg, string block, string excep)
    {
        try
        {
            ...
            SqlCommand cmd = new SqlCommand("insert into CaptureException (Ex_Page, Ex_Block, Excep, Added_On, Added_IP) values(@Ex_Page, @Ex_Block, @Excep, @Added_On, @Added_IP)", conZP);
