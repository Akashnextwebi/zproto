...
public class CreateUser
{
    ...
    public static List<CreateUser> GetAllUser(SqlConnection conZP)
    {
    ...
    public static CreateUser GetUserDetails(SqlConnection conZP, string uGuid)
    {
    ...
    public static int InsertUser(SqlConnection conZP, CreateUser comp)
    {
        int result = 0;
    ...
    public static int UpdateUser(SqlConnection conZP, CreateUser comp)
    {
        int result = 0;
        try
        {
    ...
    public static int UpdateUserByUser(SqlConnection conZP, CreateUser comp)
    {
        int result = 0;
        try
        {
    ...
    public static int UnBlockUser(SqlConnection conZP, string id, string addedBy)
    {
        int r = 0;
        try
        {
    ...
    public static int BlockUser(SqlConnection conZP, string id,string addedBy)
    {
        int r = 0;
        try
        {
    ...
    public static int DeleteUser(SqlConnection conZP, CreateUser comp)
    {
        int result = 0;
    ...
    public static CreateUser Login(SqlConnection conZP, CreateUser loginInputs)
    {
    ...
    public static CreateUser Login2(SqlConnection conZP, CreateUser loginInputs)
    {
        CreateUser login = new CreateUser();
        try
        {
    ...
    public static string ResetPassword(SqlConnection conZP, string email)
    {
        string login = "";
        try
        {
    ...
    public static string CheckPassKey(SqlConnection conZP, string uid)
    {
        string login = "";
        try
        {
    ...
    public static string CheckResetLink(SqlConnection conZP, string uid)
    {
        string login = "";
        try
        {
    ...
    public static string GetLoggedUserName(SqlConnection conZP, string uid)
    {
        string login = "";
        try
        {
    ...
    public static void UpdateLastLoginTime(SqlConnection conZP, string uid)
    {
        try
        {
    ...
    public static string GetLoggedUserId(SqlConnection conZP, string uid)
    {
        string login = "";
        try
        {
    ...
    public static bool CheckIfAdmin(SqlConnection conZP, string uid)
    {
        bool login = false;
        try
        {
    ...
    public static int SetRestId(SqlConnection conZP, string uid, string resetId)
    {
        int r = 0;
        try
        {
    ...
    public static int SetResetTiming(SqlConnection conZP, string resetId, string pwd)
    {
        int x = 0;
        try
        {
    ...
    public static string ChangePassword(SqlConnection conZP, string aId, string nPwd)
    {
        string change = "";
        try
        {
    ...
    public static List<UserAccess> GetAllUserAccess(SqlConnection conZP, string uid)
    {
    ...
    public static List<UserAccess> LinkIfAdmin(SqlConnection conZP)
    {
        List<UserAccess> categories = new List<UserAccess>();
        try
        {
    ...
    public static bool CheckAccess(SqlConnection conZP, string pageL, string accessType, string uid)
    {
        bool x = false;
        if (CheckIfAdmin(conZP, uid))
        {
            x = true;
        }
        else
        {
            ...
            {
                case "add":
                    List<UserAccess> ua = GetAllUserAccess(conZP, uid).Where(s => s.PageLink == pageName && s.AddAccess == "1").ToList();
                    if (ua.Count > 0)
                        x = true;
                    break;
                case "edit":
                    List<UserAccess> ue = GetAllUserAccess(conZP, uid).Where(s => s.PageLink == pageName && s.EditAccess == "1").ToList();
                    if (ue.Count > 0)
                        x = true;
                    break;
                case "delete":
                    List<UserAccess> ud = GetAllUserAccess(conZP, uid).Where(s => s.PageLink == pageName && s.DeleteAccess == "1").ToList();
                    if (ud.Count > 0)
                        x = true;
                    break;
                case "view":
                    List<UserAccess> uv = GetAllUserAccess(conZP, uid).Where(s => s.PageLink == pageName && s.ViewAccess == "1").ToList();
                    if (uv.Count > 0)
                        x = true;
                    break;
            }
