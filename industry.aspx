<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="industry.aspx.cs" Inherits="industry" %>
                ...
                <div class="pbmit-title-bar-content-inner">
                    <div class="pbmit-tbar">
                        <div class="pbmit-tbar-inner container">
                            <h1 class="pbmit-tbar-title">Our Aerospace & Defence Capabilities</h1>
                        </div>
                    </div>
                ...
                <div class="row row-gap-gutter">
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="industry-card">
                            ...
                            <div class="content">
                                <h3>CNC Machining</h3>
                                <p>High-precision parts and intricate designs, crafted to meet aerospace and defence specifications with exceptional accuracy. </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="industry-card">
                            ...
                            <div class="content">
                                <h3>Sheet Metal</h3>
                                <p>Custom sheet metal fabrication for structural components and enclosures, designed to withstand the most demanding environments.  </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="industry-card">
                            ...
                            <div class="content">
                                <h3>Fabrication</h3>
                                <p>Robust solutions for complex assemblies and structural elements, ensuring durability and performance in critical applications.  </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="industry-card">
                            ...
                            <div class="content">
                                <h3>Casting</h3>
                                <p>High-quality casting services for vital parts, providing strength and reliability required in aerospace and defence systems. </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="industry-card">
                            ...
                            <div class="content">
                                <h3>Forging</h3>
                                <p>Durable forged components that meet rigorous performance and safety standards, ideal for highstress environments. </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="industry-card">
                            ...
                            <div class="content">
                                ...
                                <p>Precision plastic parts molded to exact specifications, suitable for a wide range of aerospace and defence applications. </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="industry-card">
                            ...
                            <div class="content">
                                <h3>3D Printing</h3>
                                <p>Rapid prototyping and production of complex geometries, enabling quick iterations and innovative designs. </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="industry-card">
                            ...
                            <div class="content">
                                <h3>Wire Harness</h3>
                                <p>Reliable and efficient wire harnesses for complex electrical systems, ensuring connectivity and functionality in aerospace and defence systems.  </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="industry-card">
                            ...
                            <div class="content">
                                <h3>PCB Assembly</h3>
                                <p>Advanced PCB assembly for electronic systems, providing reliable performance in high-demand applications.  </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="industry-card">
                            ...
                            <div class="content">
                                <h3>Box Build</h3>
                                <p>Custom enclosures and assemblies, integrating multiple components into cohesive systems ready for deployment.  </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="industry-card">
                            ...
                            <div class="content">
                                ...
                                <p>Seamless integration of electrical and mechanical components, enhancing system functionality and performance. </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="industry-card">
                            ...
                            <div class="content">
                                <h3>Built-to-Spec</h3>
                                <p>Tailored manufacturing solutions that meet precise specifications, delivering components and systems exactly as required. </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="industry-card">
                            ...
                            <div class="content">
                                ...
                                <p>
                                    Accurate replication and enhancement of existing components, offering opportunities for design
                ...
                <div class="row flex-row-reverse mt-60">
                    <div class="col-md-6 box-left-col">
                        <div class="box-wrap">
                            ...
                            <p>
                                We onboard manufacturing partners only after comprehensive quality and capability audits to ensure they meet our stringent requirements. Our onboarding process includes: 
                            </p>
                            <ul class="list-group list-group-borderless">
                                <li class="list-group-item">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="pbmit-heading-subheading animation-style2 text-center">
                            <h2 class="pbmit-title mb-3" style="perspective: 400px;">Why Choose ZPROTO for Aerospace & Defence?</h2>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="pbmit-ihbox-style-1 process-card">
                                <div class="pbmit-ihbox-headingicon">
                                    <div class="pbmit-ihbox-contents">
                                        ...
                                        <div class="pbmit-heading-desc">Cutting-edge tools and techniques for exceptionalperformance.</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="pbmit-ihbox-style-1 process-card">
                                <div class="pbmit-ihbox-headingicon">
                                    <div class="pbmit-ihbox-contents">
                                        ...
                                        <div class="pbmit-heading-desc">Professionals with deep experience in aerospace and defence manufacturing.</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="pbmit-ihbox-style-1 process-card">
                                <div class="pbmit-ihbox-headingicon">
                                    <div class="pbmit-ihbox-contents">
                                        ...
                                        <div class="pbmit-heading-desc">Tailored services to meet exacting requirements.</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="pbmit-ele-header-align-center">
                        <div class="pbmit-heading-subheading text-center animation-style2">
                            ...
                            <p class="text-center text-white mt-2">
                                Read our Case Studies to discover how we’ve supported aerospace and defence projects with our advanced manufacturing solutions.
                            </p>
                        </div>
                        ...
                        <div class="col-md-8 tween-effect-center-col">
                            <div class="tween-effect-wrap">
                                <div class="pbmit-heading-subheading  text-start animation-style2">
                                    <h2 class="pbmit-title">Start Your Aerospace & Defence Project</h2>
                                    <div class="pbmit-heading-desc">
                                        Elevate your aerospace and defence projects with ZPROTO’s precision manufacturing
capabilities. Contact Us today to discuss your needs or schedule a consultation. 
                                    </div>
                                </div>
